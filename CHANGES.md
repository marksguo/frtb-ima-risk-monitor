...
|--------|--------|----|----|----|
| 97.5% ES | 1.72% | → flat | → flat | ▲ +10.5% |
| 97.5% VaR | 1.27% | → flat | → flat | ▲ +9.0% |
| Stressed ES | 2.55% | → flat | → flat | ▲ +3.3% |
| Liq-adj ES | 3.51% | → flat | → flat | ▲ +3.1% |

Regime: **stressed** (unchanged for 10 trading days)
