...
|--------|--------|----|----|----|
| 97.5% ES | 1.74% | → flat | → flat | ▲ +2.3% |
| 97.5% VaR | 1.37% | → flat | → flat | ▲ +16.8% |
| Stressed ES | 2.56% | → flat | → flat | ▲ +0.8% |
| Liq-adj ES | 3.60% | → flat | → flat | ▲ +2.6% |

Regime: **stressed** (unchanged for 22 trading days)
