...
|--------|--------|----|----|----|
| 97.5% ES | 1.74% | → flat | ▲ +1.2% | ▲ +11.8% |
| 97.5% VaR | 1.37% | → flat | ▲ +8.2% | ▲ +17.9% |
| Stressed ES | 2.56% | → flat | ▲ +0.4% | ▲ +3.7% |
| Liq-adj ES | 3.59% | → flat | ▲ +2.4% | ▲ +6.8% |

Regime: **stressed** (unchanged for 15 trading days)
