...
|--------|--------|----|----|----|
| 97.5% ES | 1.74% | → flat | → flat | ▲ +11.8% |
| 97.5% VaR | 1.37% | → flat | → flat | ▲ +17.9% |
| Stressed ES | 2.56% | → flat | → flat | ▲ +3.7% |
| Liq-adj ES | 3.60% | → flat | ▲ +0.1% | ▲ +6.9% |

Regime: **stressed** (unchanged for 18 trading days)
