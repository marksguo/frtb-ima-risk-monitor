...
|--------|--------|----|----|----|
| 97.5% ES | 1.74% | → flat | → flat | ▲ +1.2% |
| 97.5% VaR | 1.37% | → flat | → flat | ▲ +8.2% |
| Stressed ES | 2.56% | → flat | → flat | ▲ +0.4% |
| Liq-adj ES | 3.60% | → flat | → flat | ▲ +2.5% |

Regime: **stressed** (unchanged for 24 trading days)
